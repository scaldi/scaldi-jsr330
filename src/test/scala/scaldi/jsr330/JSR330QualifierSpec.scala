...
class AnnotatedTest1 @Inject() (
    @TestQualifier("dep1") val dep1: AnnotatedDep,
    @TestQualifier("dep2") val dep2: AnnotatedDep
)
class AnnotatedTest2(implicit inj: Injector) extends Injectable {
  val dep1: AnnotatedDep = inject[AnnotatedDep](identified by annotation(TestQualifierImpl.of("dep1")))
  val dep2: AnnotatedDep = inject[AnnotatedDep](identified by annotation(TestQualifierImpl.of("dep2")))
  val dep: AnnotatedDep  = inject[AnnotatedDep](identified by qualifier[TestQualifier])
}
